...
## Two Options:
1. Add the contents of `Mend APITest` into the `Mend API` folder's tests section to apply to all requests. This will catch any 401 response and automatically login and set auth tokens in your environment. (Recommended)
